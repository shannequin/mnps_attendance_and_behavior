...
# Explore and clean MNPS behavior data
```{r}
# Read data
...
```{r}
# Ignore SCHOOL column value *DISTRICT? Maybe reconcile with state and district data
...
```{r}
# Ignore SchoolName column value *DISTRICT? Maybe reconcile with state and district data
...
mnps_behavior_df |> 
    ...
    # Create new columns for numeric percentages
